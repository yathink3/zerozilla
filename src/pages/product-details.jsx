    ...
    <div className='grid grid-cols-1 gap-3'>
      {loader == true ? (
        ...
        <div className='grid grid-cols-1 gap-10 p-10'>
          ...
          <button className=' text-sm p-1 rounded transition duration-200 text-gray-600 hover:text-white focus:text-white focus:outline-none focus:bg-gray-700 hover:bg-gray-700 ' onClick={() => addToCart(data)}>
            ADD TO CART
          </button>

          {cartFind && (
            <button className=' text-sm p-1 rounded transition duration-200 text-gray-600 hover:text-white focus:text-white focus:outline-none focus:bg-gray-700 hover:bg-gray-700 ' onClick={() => removeFromCart(cartFind)}>
              REMOVE FROM CART {cartFind.count > 1 && cartFind.count}
            </button>
          )}
        </div>
      )}
